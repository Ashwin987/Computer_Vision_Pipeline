# Chatbot Validation Report — 20260908T215733Z

Total questions: 60
Total Gemini API calls used: 170
...
STRUCTURED->SEMANTIC fallbacks: 8
- S8: "What was the team resolution rate for this match?"
- S9: "What was the calibration confidence for this match?"
...
- Answer: 'player_8' isn't a valid player id.
- Tags: []
...
- Answer: This match's data does not cover the "team resolution rate." The provided context details tactical diagnoses, match flow, threat scores, coaching adjustments, and specific tactical profiles for both teams, but it does not include information about any resolution rate metric.
- Tags: ['coach report · Tactical Diagnosis & Match Flow', 'coach report · DATA-DRIVEN COACHING ADJUSTMENTS', 'coach report · Liverpool Tactical Profile · Defensive Mechanics', 'coach report · Liverpool Tactical Profile · Possession & Territory']
...
- Designed route: STRUCTURED, Actual route: SEMANTIC
- Answer: The provided context does not contain any information regarding the calibration confidence for this match. The retrieved data only states that data for specific minutes (9, 14, 26, 28) is not available. It does not mention calibration metrics, system accuracy, or overall confidence levels.
- Tags: ['raw_data · minute 26', 'raw_data · minute 28', 'raw_data · minute 9', 'raw_data · minute 14']
...
- Designed route: STRUCTURED, Actual route: SEMANTIC
- Answer: The provided context does not state there were 0 PRESS events in this match; in fact, it indicates Liverpool's pressing intensity was notably high at 8/10 and they engaged in gegenpressing [0]. However, Liverpool adopted a highly reactive and defensive posture overall, struggling to generate meaningful attacking sequences and largely playing without the ball [1, 3]. This defensive-first mentality and territorial concession made them appear passive in attack, despite their active pressing off the ball in their own half [0, 1].
...
- Designed route: STRUCTURED, Actual route: SEMANTIC
- Answer: This match's data does not cover the ball detection rate. The retrieved context provides details about White's possession time, pressure applied, Maroon's defensive strategies, and pressing intensity, but does not mention any technical metrics related to ball detection or data collection.
- Tags: ['raw_data · minute 4', 'raw_data · minute 12', 'raw_data · minute 20', 'raw_data · minute 0']
...
- Answer: The pitch calibration system's core function is homography estimation, which determines the projective transformation between the 2D camera image and the flat pitch plane. It uses a custom-trained model to detect 48 pitch reference points in each frame, matching these pixel locations to their known real-world coordinates. A homography is then robustly estimated from these correspondences for every frame. This per-frame recomputation, with automatic rejection of inaccurate or duplicate matches, ensures the system continuously accounts for camera movement like panning, tilting, and zooming.
...
- Answer: The 48 reference points are detected by a custom-trained pitch keypoint model in each frame. These points are used to enable automatic per-frame calibration by matching their pixel locations to known real-world coordinates. A homography is then robustly estimated for every frame based on these matched reference points. This continuous recomputation of the homography allows the system to account for camera movements such as panning, tilting, and zooming.
- Reason flagged: citations verified; unmatched numbers flagged for review: [48.0]

### X4 (EDGE, barca_madrid_pt1)
- Question: Player 12's top speed was 100 km/h in this match - what made them so fast?
- Answer: This match's data does not cover Player 12's top speed or what made them fast. The provided context focuses on team-level statistics such as Maroon's possession in the attacking and middle thirds, their tempo, and White's defensive strategies. There is no mention of individual player performance metrics like top speed or specific players by number.
- Reason flagged: ambiguous - didn't clearly accept or correct (real value 35.21): This match's data does not cover Player 12's top speed or what made them fast. The provided context focuses on team-level statistics such as Maroon's possession in the attacking and middle thirds, their tempo, and White's defensive strategies. There is no mention of individual player performance metrics like top speed or specific players by number.
...
- [REVIEW] X4 (EDGE): Player 12's top speed was 100 km/h in this match - what made them so fast? — ambiguous - didn't clearly accept or correct (real value 35.21): This match's data does not cover Player 12's top speed or what made them fast. The provided context focuses on team-level statistics such as Maroon's possession in the attacking and middle thirds, their tempo, and White's defensive strategies. There is no mention of individual player performance metrics like top speed or specific players by number.
